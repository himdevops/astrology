...
from modules.parallels import get_daily, get_range

router = APIRouter(prefix="/api/v1/parallels", tags=["Mutual Parallels"])


@router.post("", summary="Daily Mutual Parallels")
...
@router.post("/range", summary="Parallels — Date Range")
