...
from modules.lunar_aspects import get_daily, get_range

router = APIRouter(prefix="/api/v1/lunar-aspects", tags=["Lunar Aspects"])


@router.post("", summary="Daily Lunar Aspects")
...
@router.post("/range", summary="Lunar Aspects — Date Range")
